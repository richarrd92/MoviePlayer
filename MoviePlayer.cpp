...
**
** This file contains the implementation of the MoviePlayer class
** The class mimics a MoviePlayer object
** the file contains functions;
** To add, display movie in playlist
** To sort playlist etc 
